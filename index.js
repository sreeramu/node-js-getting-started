...
express()
  ...
  .post('/', function(req,res) {
	...
	// Get the response body
	  ...
	  var response = "{\"payload\": {\"google\": {\"expectUserResponse\": true,\"richResponse\": {\"items\": [{\"mediaResponse\": {\"mediaType\": \"AUDIO\",\"mediaObjects\": [{\"name\": \"mediaResponse name\",\"description\": \"mediaResponse description\",\"largeImage\": {\"url\": \"https://i.stack.imgur.com/SuVxV.jpg?s=48&g=1\"},\"contentUrl\": \"http://cdl18.convert2mp3.net/download.php?id=youtube_3pDfR3XDgk8&key=MSjwWGGZFJ1Q&d=y\"}]}}]}}}}";
